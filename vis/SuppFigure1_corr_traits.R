...
# heatmap plot
setwd('/gpfs/ysm/pi/zhao-data/jh2875/ps_PRS/clean/res/figure/') # path to save figures
...
pheatmap(corr_out,border=TRUE,border_color='grey60',
	 ...
	 clustering_method = "average",cluster_rows=F,cluster_cols=F,
         breaks = seq(-2,2,0.008),legend_breaks = seq(-2,2,0.8),legend_labels = c(seq(-2,2,0.8)),
