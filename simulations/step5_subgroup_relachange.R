# Calculate relative change of phenotypes across subgroups
...
psprs <- paste0('simu_PRS_Observed_Beta_Trait1_',1:4)
...
label <- c(paste0('Trait ',2:4,'-related Subgroup'),
           'Others Subgroup')
...
p <- getPlot(res)
saveRDS(p,'rela_chan_subgroup.RDS')

pdf('rela_chan_subgroup.pdf')
print(p)
